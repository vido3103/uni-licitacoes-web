...
export default function Negocios({onNavigate}:{onNavigate?:(module:string)=>void}){
 ...
 function openOpportunity(r:Row){const oid=String(r.opportunity_id||"");if(oid)sessionStorage.setItem("uni-opportunity-open",oid);onNavigate?.("Oportunidades")}
